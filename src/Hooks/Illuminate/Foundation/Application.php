...
use OpenTelemetry\Contrib\Instrumentation\Laravel\Watchers\ContainerWatcher;
    ...
    public function instrument(): void
    {
        hook(
            ...
            post: function (FoundationalApplication $application, array $params, mixed $returnValue, ?Throwable $exception) {
                ...
                $this->registerWatchers($application, new ContainerWatcher($this->instrumentation));
